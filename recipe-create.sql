...
create table ingridient (id bigint not null auto_increment, amount decimal(19,2), description varchar(255), recipe_id bigint, uom_id bigint, primary key (id)) engine=InnoDB;
...
alter table ingridient add constraint FKciih5rn5vd46crl3jf68rkk6e foreign key (recipe_id) references recipe (id);
alter table ingridient add constraint FKt20eqligiioaveesxv1wx1t02 foreign key (uom_id) references unit_of_measure (id);
