...
public class UnitOfMeasureRepositoryTestIT {
    ...
    @Test
   // @DirtiesContext -- RELOAD CONTEX
    public void findByDescriptionCup() {
        Optional<UnitOfMeasure> unit = unitOfMeasureRepository.findByDescription("Cup");
        Assert.assertEquals("Cup",unit.get().getDescription());
    }

    @Test

    public void findByDescriptionTea() {
        Optional<UnitOfMeasure> unit = unitOfMeasureRepository.findByDescription("Teaspoon");
        Assert.assertEquals("Teaspoon",unit.get().getDescription());
    }
}